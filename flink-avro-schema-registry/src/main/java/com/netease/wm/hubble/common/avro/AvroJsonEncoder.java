...
/**
 * Modified JsonEncoder for Avro to make nullable field output more nature
 *
 * refer: https://issues.apache.org/jira/browse/AVRO-1582
 */
public class AvroJsonEncoder extends ParsingEncoder implements Parser.ActionHandler {
    ...
    public AvroJsonEncoder(Schema sc, OutputStream out) throws IOException {
        this(sc, getJsonGenerator(out, false));
    }

    public AvroJsonEncoder(Schema sc, OutputStream out, boolean pretty) throws IOException {
     ...
     */
    public AvroJsonEncoder configure(OutputStream out) throws IOException {
     ...
     * @return this JsonEncoder
     */
    private AvroJsonEncoder configure(JsonGenerator generator) throws IOException {
    ...
    public void writeIndex(int unionIndex) throws IOException {
        ...
        if (symbol != Symbol.NULL && !isNullableSingle(top) && includeNamespace) {
            out.writeStartObject();
