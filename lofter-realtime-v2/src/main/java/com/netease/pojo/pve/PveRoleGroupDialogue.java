...
public class PveRoleGroupDialogue {
    private String tableName;
    private Long id;
    private Long userId;
    private Long groupId;
    private Long pveUserId;
    private Long roleId;
    ...
    public Long getPveUserId() {
        return pveUserId;
    }

    public void setPveUserId(Long pveUserId) {
    ...
    public Integer getAiSource() {
        return aiSource;
    }

    public void setAiSource(Integer aiSource) {
