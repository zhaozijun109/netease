...
@Getter
@Setter
public class ClickHouseTagQuery extends BaseQuery {
    private static final long serialVersionUID = -2067035197915437076L;
    ...
    public Map<String, Object> buildMap() {
        ...
        params.put("tags", split(getTags()));
        params.put("ips", split(ips));
