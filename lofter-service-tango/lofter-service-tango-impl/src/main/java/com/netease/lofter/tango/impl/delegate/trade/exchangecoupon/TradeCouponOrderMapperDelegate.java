...
import com.netease.lofter.tango.impl.entity.trade.exchangecoupon.TradeCouponOrder.Fields;
import com.netease.lofter.tango.impl.mapper.trade.exchangecoupon.TradeCouponOrderMapper;
...
@Primary
@Service
public class TradeCouponOrderMapperDelegate implements CommonService<TradeCouponOrderMapper, TradeCouponOrder>, DeleteCommonService<TradeCouponOrderMapper, TradeCouponOrder>{

    public PageDO<TradeCouponOrder> listByQuery(Long createTimeBegin,
                                                Long createTimeEnd,
                                                Long id,
                                                Long tradeId,
                                                Long userId,
        ...
        List<TradeCouponOrder> list = selectList(sqlSelect);
