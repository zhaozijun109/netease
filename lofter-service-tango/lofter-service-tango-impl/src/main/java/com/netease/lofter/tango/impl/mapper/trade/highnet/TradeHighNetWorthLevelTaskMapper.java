package com.netease.lofter.tango.impl.mapper.trade.highnet;
...
public interface TradeHighNetWorthLevelTaskMapper extends CommonMapper<TradeHighNetWorthLevelTask>, DeleteCommonMapper<TradeHighNetWorthLevelTask>{
}