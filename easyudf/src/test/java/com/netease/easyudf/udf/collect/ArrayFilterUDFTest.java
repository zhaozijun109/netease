...
public class ArrayFilterUDFTest {
    private ArrayFilterUDF udf;

    @Before
    public void before() {
        udf = new ArrayFilterUDF();
    }
    ...
    public void evaluate() throws HiveException {
        ...
        ListObjectInspector resultOi = (ListObjectInspector) udf.initialize(new ObjectInspector[]{listOi, listOi});
        ...
        System.out.println(resultOi.getList(result));
    }
}