...
public class BitOrUDAF extends AbstractGenericUDAFResolver {

    static final Log LOG = LogFactory.getLog(BitOrUDAF.class.getName());
    ...
    public static class GenericUDAFBitOpLong extends GenericUDAFEvaluator {
        ...
        private Method method = Method.OR;
