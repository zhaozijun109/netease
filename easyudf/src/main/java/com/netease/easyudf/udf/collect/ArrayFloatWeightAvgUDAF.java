 ...
 */
public final class ArrayFloatWeightAvgUDAF extends UDAF {

    public static class UDAFArrayFloatEvaluator implements UDAFEvaluator {

        public static final class State {
            public List<Float> sumValue = null;
            public float sumWeight = 0.f;
        }

        State state;

        public UDAFArrayFloatEvaluator() {
            init();
        }
        ...
        public boolean iterate(List<Float> value, Float weight) {
