...
public class DimVcUserRichFlatMapFunction extends RichFlatMapFunction<String, BinlogRow> {
    ...
    public void flatMap(String s, Collector<BinlogRow> collector) throws Exception {
        ...
        if ("vc_user_account".equalsIgnoreCase(binlogRow.getTable()) && binlogRow.getOp() == 0) {
