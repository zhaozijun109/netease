...
object DsJsonLogToHdfsLoader {
  ...
  def main(args: Array[String]): Unit = {
    ...
    properties.setProperty("group.id", "ds_log_to_hdfs")
    ...
    logSource
      .flatMap { line =>
        ...
        val json = parse(line)
        (json \ "body").extract[String] match {
    ...
    env.execute(s"DsJsonLogToHdfs from kafka: $topic")
  }
}
