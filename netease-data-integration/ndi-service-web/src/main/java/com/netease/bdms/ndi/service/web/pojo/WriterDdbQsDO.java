...
public class WriterDdbQsDO {
  ...
  public WriterDdbQsDO() {
  }

  public WriterDdbQsDO(JSONObject dataSource, Integer insertType, String preSql, String postSql, String conf) {
  ...
  public WriterDdbQsDO(Long id, JSONObject dataSource, Integer insertType, String preSql, String postSql, String conf) {
    this.id = id;
    this.dataSource = dataSource;
    this.insertType = insertType;
    this.preSql = preSql;
