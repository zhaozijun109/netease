...
public class ReaderOracleDO {
    ...
    public ReaderOracleDO() {
    }

    public ReaderOracleDO(JSONArray dataSources, String conditions, String conf) {
    ...
    public ReaderOracleDO(Long id, JSONArray dataSources, String conditions, String conf) {
        this.id = id;
        this.dataSources = dataSources;
        this.conditions = conditions;
        this.conf = conf;
