...
public class WriterMySQLDO {
  ...
  public WriterMySQLDO() {
  }

  public WriterMySQLDO(JSONObject dataSource, Integer insertType, String preSql, String postSql, String conf) {
  ...
  public WriterMySQLDO(Long id, JSONObject dataSource, Integer insertType, String preSql, String postSql, String conf) {
    this.id = id;
    this.dataSource = dataSource;
    this.insertType = insertType;
    this.preSql = preSql;
