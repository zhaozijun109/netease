...
package org.apache.spark.ml.regression_
...
private[ml] object FactorizationMachines {
  ...
  def getRawPrediction(
    ...
    var rawPrediction = intercept + BLAS.dot(features, linear)
 ...
 */
trait FMRegressorParams extends FactorizationMachinesParams {
}
