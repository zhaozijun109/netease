...
package org.apache.spark.ml.classification_
...
import org.apache.spark.ml.regression_.FactorizationMachines._
import org.apache.spark.ml.regression_.{FactorizationMachines, FactorizationMachinesParams}
 ...
 */
trait FMClassifierParams extends ProbabilisticClassifierParams
...
class FMClassifier @Since("3.0.0")(
  ...
  override protected def train(
    ...
    val numFeatures = org.apache.spark.ml.util_.MetadataUtils.getNumFeatures(dataset, $(featuresCol))
