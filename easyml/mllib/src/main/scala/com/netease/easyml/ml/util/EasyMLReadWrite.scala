...
// This originates from apache-spark ReadWrite copy paste
private[easyml] object DefaultEasyMLParamsWriter {
...
private[easyml] object DefaultEasyMLParamsReader {
  ...
  /**
   * Load metadata saved using [[DefaultEasyMLParamsWriter.saveMetadata()]]
   *
  ...
  /**
   * Parse metadata JSON string produced by [[DefaultEasyMLParamsWriter.getMetadataToSave()]].
