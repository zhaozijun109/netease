 ...
 */
@Register(alias = Array("mean_absolute_error", "mae"))
class MeanAbsoluteError(override val uid: String) extends Metric
  with HasPredictionCol with HasLabelCol
  with DefaultParamsWritable {

  def this() = this(Identifiable.randomUID("mean_absolute_error"))

  override lazy val shortName: String = "mean_absolute_error"
