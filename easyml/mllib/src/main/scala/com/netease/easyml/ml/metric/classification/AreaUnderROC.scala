 ...
 */
@Register(alias = Array("auc", "areaUnderRoc"))
class AreaUnderROC(override val uid: String) extends Metric with HasRawPredictionCol with HasLabelCol with DefaultParamsWritable {

  def this() = this(Identifiable.randomUID("auc"))

  override lazy val shortName: String = "auc"
